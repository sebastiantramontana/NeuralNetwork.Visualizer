...
namespace NeuralNetwork.Visualizer.Drawing.Nodes
{
   ...
   {
      internal BiasDrawing(Bias element, IPreference preferences, SimpleNodeSizesPreCalc cache, ISelectableElementRegister selectableElementRegister, IElementSelectionChecker selectionChecker, IRegionBuilder regionBuilder) : base(element, preferences.Biases, cache, selectionChecker, selectableElementRegister, regionBuilder)
      {
      }
   }
}
